...
class AddressVC2: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        CommonManager.setBorder(textField: txtStreet )
        CommonManager.setBorder(textField: txtCode )
        CommonManager.setBorder(textField: txtApprt )
        CommonManager.setCorner(button: btnSaveLocation)
