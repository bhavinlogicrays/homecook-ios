...
//        arrProgress = ["In Progress","In Progress","Complete","Canceled"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.lblReviewcount.text = "(120)"
        cell.lblStar.text = "4.9"
        cell.lblCatType.layer.cornerRadius = cell.lblCatType.frame.size.height/2
        cell.lblCatType.layer.masksToBounds = true
        return cell
    }
