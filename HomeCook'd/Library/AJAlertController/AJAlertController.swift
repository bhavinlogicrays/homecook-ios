...
class AJAlertController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnOK.layer.borderColor = UIColor.clear.cgColor
    ...
    private func preferredAlertWidth() {
        switch UIDevice.current.userInterfaceIdiom {
            case .phone:
                alertWidthConstraint.constant = self.view.frame.size.width - 20 
            case .pad:
...
//        hide()
    ...
    public func showAlertWithOkButton( title:String,message:String, completion : alertCompletionBlock){
        strAlertTitle = title
